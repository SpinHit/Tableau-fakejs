...
function firstLine(a){
 ...
 var telephone = document.createElement("th");
 telephone.innerHTML="Numero de telephone";
 premiereLigne.appendChild(telephone)
  ...
  // nombre de case
    ...
    for(x=0 ; x<n ; x++){
        ...
        first: faker.fake("{{name.firstName}}"),
            ...
            telephone: faker.fake("{{phone.phoneNumber}}"),
        ...
        for (var i = 0; i <1; i++) {
            ...
            case5.innerHTML=person.telephone;
